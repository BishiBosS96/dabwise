@extends("layouts.app")
@section("content")
<div class="container-fluid hidden-xs hidden-sm" id="wrapper">
	
	<div class="col-xs-12 col-lg-6 col-lmd-6 col-sm-6 col-sm-offset-3">
		<div id="slider">
		<div class="slide" style="background-image: url('{{asset('images/iceage.jpg')}}');">
		...
		<div class="slide" style="background-image: url('{{asset('images/birds.jpg')}}');">
			<div class="slide-block">
				<h4>For The Birds</h4>
		...
		<div class="slide" style="background-image: url('{{asset('images/up.jpg')}}');">
			<div class="slide-block">
				<h4>UP</h4>
...
<div class="row carousel-row hidden-md hidden-lg">
	...
	$(function() {
		$('#slider').carouFredSel({
			...
			onCreate: function(data){
				...
				document.getElementById("slider").parentElement.style.marginTop ="0px"
			}
		});
